...
const ProjectCard = ({
  ...
  return (
    ...
    >
      <div
        className={`border-b border-dimmed border-opacity-[0.01] relative group overflow-hidden hover:border-brand even:hover:skew-y-1 hover:scale-[.994] delayed hover:animat e-pulse peer ${
      ...
      >
        ...
        {fullCard && (
          <div className="col-span-1 lg:col-span-4 flex item s-center justify-between">
            <div className="flex-grow">
              <h3 className="text-base group-hover:text-brand tracking-wider delayed z-[-1]">
                {title}
              </h3>
            ...
            <div>
              <Link
                className="text-sm group-hover:text-brand px-2 py-1 border opacity-0 border-brand group-hover:opacity-100 invisible group-hover:visible rounded delayed w-auto flex flex-wrap text-center"
